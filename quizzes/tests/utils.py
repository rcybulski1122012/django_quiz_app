...
from quizzes.models import Category, Quiz, Answer, Question
...
class QuizzesUtilsMixin:
    ...
    def post_create_view_with_one_question_quiz(self, title=QUIZ_TITLE, description=QUIZ_DESC, category=None,
