...
class TestUserRegistrationForm(TestCase):
    @staticmethod
    def get_example_form_data(username='User123', email='emailaddress123@gmail.com', p1='SecretPass123',
                              p2='SecretPass123'):
    ...
    def test_invalid_when_account_with_the_same_email_already_exists(self):
        User.objects.create_user('FirstUser', 'emailaddress123@gmail.com', 'SecretPas123')
